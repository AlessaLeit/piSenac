...
def test_despesa_filtrar(forn_teste, func_teste, prod_teste, supr_teste, maq_teste_operando):
    ...
    assert len(res) == 0
    assert d4 in res # d4 é Outros, tem "limpeza", mas não tem fornecedor_obj=forn_teste
    # Reavaliando o filtro combinado: d4 não tem forn_teste, então o resultado deve ser 0.
    # A lógica de filtro atual é AND para todos os critérios.
